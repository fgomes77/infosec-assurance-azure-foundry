...
| R23 | Backup / DR — templates and knowledge in git + export, vector stores rebuilt by `../deploy.sh`, memory store export, Logic Apps definitions in repo, SharePoint versioning — procedures: `../operations/BACKUP_DR.md` (inventory §1, RPO/RTO §2, restore §4, region failure §5, tests §6) | quarterly test | **A/R** | I | I | I | I | R (restore drill when FGG absent) | I |
