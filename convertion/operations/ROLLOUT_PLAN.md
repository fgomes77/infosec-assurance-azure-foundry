...
| T4 Threads, memory, data protection | thread naming, team visibility, retention; memory note format; what never goes into memory; injection defence; how to report an AI concern | `../team/TEAM_MODEL.md` §13, `../team/USER_QUICKSTART.md` | one memory note; quiz Q7–Q8 |
